...
RSpec.describe ComentariosController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all comentarios as @comentarios" do
      ...
      expect(assigns(:comentarios)).to eq([comentario])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested comentario as @comentario" do
      ...
      expect(assigns(:comentario)).to eq(comentario)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created comentario as @comentario" do
        ...
        expect(assigns(:comentario)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved comentario as @comentario" do
        post :create, {:comentario => invalid_attributes}, valid_session
        expect(assigns(:comentario)).to be_a_new(Comentario)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested comentario" do
        comentario = Comentario.create! valid_attributes
        put :update, {:id => comentario.to_param, :comentario => new_attributes}, valid_session
        comentario.reload
    ...
    describe "with invalid params" do
      it "assigns the comentario as @comentario" do
        comentario = Comentario.create! valid_attributes
        put :update, {:id => comentario.to_param, :comentario => invalid_attributes}, valid_session
        expect(assigns(:comentario)).to eq(comentario)
      end
